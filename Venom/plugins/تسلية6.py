...
@mody.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular SourceZe",
    },
)
...
@mody.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular SourceZe",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@mody.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna SourceZe is One of the Popular SourceZe",
    },
)
async def nekobot(cat):
...
@mody.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; SourceZe is One of the Popular SourceZe",
    },
)
async def nekobot(cat):
