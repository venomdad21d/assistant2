...
#
# This file is a part of < https://github.com/ar-Thon/ze/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/ar-Thon/ze/blob/main/LICENSE/>.
...
# Copyright (C) 2021 ar-Thon . All Rights Reserved
# الـرتب الوهميـه & البريميـوم كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    if user_id in ze: # code by t.me/zzzzl1l
        rotbat = "⌁ مطـور السـورس 𓄂𓆃 ⌁" 
    elif user_id in ze_dev:
        rotbat = "⌁ مطـور مسـاعـد 𐏕⌁" 
    elif user_id == (await event.client.get_me()).id and user_id not in ar_dev:
        rotbat = "⌁ مـالك الحساب 𓀫 ⌁" 
    else:
        rotbat = "⌁ العضـو 𓅫 ⌁"
    caption = f"<b> {ar_TEXT} </b>\n"
    caption += f"ٴ<b>{arF}</b>\n"
    caption += f"<b>{arM}الاسـم    ⇠ </b> "
    ...
    if user_id != (await event.client.get_me()).id: # code by t.me/zzzzl1l
        caption += f"<b>{arM}الـمجموعات المشتـركة ⇠ </b> {common_chat} \n"
    caption += f"<b>{arM}البايـو     ⇠  {user_bio}</b> \n"
    caption += f"ٴ<b>{arF}</b>"
