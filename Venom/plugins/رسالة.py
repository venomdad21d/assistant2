...
@mody.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}رسالة @Source_Ze حي الله  ان",
    },
)
...
@mody.ar_cmd(pattern="ازالة التوجيه")
async def Reda (event):
    if event.message.reply_to_msg_id:
        ...
        if replied_msg.media:
            ...
            await mody.send_message(event.chat_id, "", file=replied_msg.media)
        else:
            
            await mody.send_message(chat_id=event.chat_id, message=replied_msg.message)
    else:
