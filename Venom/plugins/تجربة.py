...
@mody.ar_cmd(pattern="امر التجربه")
async def hi(event):
    await edit_or_reply(
        event,
        "**[ᯓ 𝐙𝐄 𝐔𝐒𝐄𝐑𝐁𝐎𝐓 - تنفيــذ الاكــواد](t.me/UI_XB)\n⋆─┄─┄─┄──┄─┄─┄─⋆**\n\n الامر: `.تجربه` + كود برمجي\n- يقوم بتشغيل الكود و إظهار النتيجة",
        link_preview=False,
    )


@mody.ar_cmd(pattern="تجربه(?:\s|$)([\s\S]*)")
async def _(event):
    ...
    SourceZe = await edit_or_reply(event, "**- جار تنفيـذ الكـود .. انتظـر**")
