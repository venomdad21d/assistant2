...
@l313l.on(admin_cmd(pattern="(تجميع المصريين|المصريين)"))
async def _(event):
    if ze[0] == "yes":
        ...
        await l313l.send_message('@QPEBOT', '/start')
        await asyncio.sleep(5)
        msg0 = await l313l.get_messages('@QPEBOT', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await l313l.get_messages('@QPEBOT', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await l313l.get_messages('@QPEBOT', limit=1)
