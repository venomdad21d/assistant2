...
joker_users = []
joker_mute = "https://telegra.ph/file/a667484914f6d684acd27.jpg"
joker_unmute = "https://telegra.ph/file/ec01045e1bd5aac283c9d.jpg"
#=================== الكـــــــــــــــتم  ===================  #

@mody.ar_cmd(pattern=f"كتم(?:\s|$)([\s\S]*)")
...
@mody.ar_cmd(pattern=f"(الغاء الكتم|الغاء كتم)(?:\s|$)([\s\S]*)")
...
@mody.ar_cmd(pattern=r"قائمة المكتومين")
