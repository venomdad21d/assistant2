# Source-Ze
# Copyright (C) 2022 Source-Ze . All Rights Reserved
#
# This file is a part of < https://github.com/Source-Ze/ZESOURCE/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/Source-Ze/ZESOURCE/tree/SourceZe/LICENSE/>.
import asyncio
import requests
import logging
...
@mody.ar_cmd(pattern="(ضع الاشتراك خاص|وضع الاشتراك خاص)(?:\s|$)([\s\S]*)")
async def _(event):
...
@mody.ar_cmd(pattern="(ضع الاشتراك كروب|وضع الاشتراك كروب)(?:\s|$)([\s\S]*)")
async def _(event):
    if input_str := event.pattern_match.group(2):
        try:
            p = await event.client.get_entity(input_str)
    ...
    if gvarstatus ("sub_private"):
        try:
            ...
            try:
                ...
                return await mody.tgbot.send_message(BOTLOG_CHATID, f"**- خطـأ \n{r}**")
