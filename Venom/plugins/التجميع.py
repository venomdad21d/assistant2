...
async def Hussein(event):
    if event.message.message.startswith("تجميع المليار") and str(event.sender_id) in ConsoleJoker:
        ...
        await mody.send_message(bot_username, '/start')
        await asyncio.sleep(4)
        msg0 = await mody.get_messages(bot_username, limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(4)
        msg1 = await mody.get_messages(bot_username, limit=1)
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await mody.send_message(event.chat_id, f"تم الانتهاء من التجميع")
            ...
            try:
                ...
                msg2 = await mody.get_messages(bot_username, limit=1)
...
async def Hussein(event):
    if event.message.message.startswith("تجميع الجوكر") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await mody.get_entity(bot_username2)
        await mody.send_message('@A_MAN9300BOT', '/start')
        await asyncio.sleep(2)
        msg0 = await mody.get_messages('@A_MAN9300BOT', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(2)
        msg1 = await mody.get_messages('@A_MAN9300BOT', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await mody(ImportChatInviteRequest(bott))
                msg2 = await mody.get_messages('@A_MAN9300BOT', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
...
async def Hussein(event):
    if event.message.message.startswith("تجميع العقاب") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await mody.get_entity(bot_username3)
...
async def Hussein(event):
    if event.message.message.startswith("تجميع المليون") and str(event.sender_id) in ConsoleJoker:
        ...
        channel_entity = await mody.get_entity(bot_username4)
...
@mody.on(admin_cmd(pattern="(تجميع المليار|تجميع مليار)"))
async def _(event):
...
@mody.on(admin_cmd(pattern="(ايقاف التجميع|ايقاف تجميع)"))
async def cancel_collection(event):
    await mody.send_message('@EEObot', '/start')
    await event.edit("** ۞︙ تم الغاء التجميع من بوت المليار **")
    
@mody.on(admin_cmd(pattern="(تجميع الجوكر|تجميع جوكر)"))
async def _(event):
    if SourceZe[0] == "yes":
        ...
        await event.edit("يجب الدفع لاستعمال هذا الامر !")
@mody.on(admin_cmd(pattern="(تجميع العقاب|تجميع عقاب)"))
async def _(event):
    if SourceZe[0] == "yes":
        ...
        await event.edit("يجب الدفع لاستعمال هذا الامر !")
@mody.on(admin_cmd(pattern="(تجميع المليون|تجميع مليون)"))
async def _(event):
    if SourceZe[0] == "yes":
        ...
        await event.edit("يجب الدفع لاستعمال هذا الامر !")
@mody.on(admin_cmd(pattern="(تجميع العرب|تجميع عرب)"))
async def _(event):
    ...
    channel_entity = await mody.get_entity(bot_username5)
    await mody.send_message(bot_username5, '/start')
    await asyncio.sleep(4)
    msg0 = await mody.get_messages(bot_username5, limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(4)
    msg1 = await mody.get_messages(bot_username5, limit=1)
    await msg1[0].click(0)
    ...
    for i in range(100):
        ...
        try:
            try:
                ...
                bott = url.split('/')[-1]
                await mody(ImportChatInviteRequest(bott))
            msg2 = await mody.get_messages(bot_username5, limit=1)
            await msg2[0].click(text='تحقق')
            chs += 1
            await event.edit(f"تم الانضمام في {chs} قناة")
        except:
    ...
    await mody.send_message(event.chat_id, "تم الانتهاء من التجميع")
@mody.on(admin_cmd(pattern="تجميع دعمكم"))
async def _(event):
    ...
    await asyncio.sleep(4)
    msg1 = await mody.get_messages(bot_username6, limit=1)
    await msg1[0].click(0)
    chs = 1
    for i in range(100):
        await asyncio.sleep(4)
        ...
        if "اشترك فالقناة @" in msg_text:
            ...
            try:
                entity = await mody.get_entity(aljoker_channel)
                if entity:
...
@mody.ar_cmd(pattern="راتب وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    global its_hussein
    await event.delete()
    if not its_hussein:
...
async def send_reham(event):
    ...
    if its_hussein:
        await send_reham(event)  
@mody.ar_cmd(pattern="ايقاف راتب وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    global its_hussein
    its_hussein = False
    await event.edit("**تم تعطيل راتب وعد بنجاح ✅**")
@mody.ar_cmd(pattern="بخشيش وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    global its_joker
    await event.delete()
    if not its_joker:
...
async def send_aljoker(event):
    ...
    if its_joker:
        await send_aljoker(event)  
@mody.ar_cmd(pattern="ايقاف بخشيش وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    global its_joker
    its_joker = False
    await event.edit("**۞︙ تم تعطيل بخشيش وعد بنجاح ✓ **")
@mody.ar_cmd(pattern="سرقة وعد(?:\s|$)([\s\S]*)")
async def hussein(event):
    global its_reda
    await event.delete()
    if not its_reda:
...
@mody.ar_cmd(pattern="ايقاف سرقة وعد(?:\s|$)([\s\S]*)")
...
@mody.ar_cmd(pattern="استثمار وعد")
async def w3d_joker(event):
    ...
    while its_Reham:
        if event.is_group:
            ...
            mody = aljoker[0]
            if mody.isdigit() and int(mody) > 500000000:
                await event.client.send_message(event.chat_id,f"استثمار {mody}")
...
@mody.ar_cmd(pattern="ايقاف استثمار وعد")
