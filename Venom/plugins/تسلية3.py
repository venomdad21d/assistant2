...
from . import mody, edit_delete, edit_or_reply, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m SourceZe`",
        "**State changed from starting to up**",
        "__INFO:SourceZe:Logged in as 557667062__",
        "__INFO:SourceZe:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
