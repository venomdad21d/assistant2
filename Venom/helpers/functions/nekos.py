...
async def fakegs(search, result):
    ...
    blue = (0, 0, 255)
    black = (0, 0, 0)
    font1 = ImageFont.truetype("SourceVenom/helpers/styles/ProductSans-BoldItalic.ttf", 20)
    font2 = ImageFont.truetype("SourceZe/helpers/styles/ProductSans-Light.ttf", 23)
