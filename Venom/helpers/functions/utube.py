...
PATH = "./SourceZe/cache/ytsearch.json"
...
async def yt_search(SourceVenom):
    try:
        SourceVenom = urllib.parse.quote(SourceVenom)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={SourceZe}"
        )
...
"""
async def yt_data(SourceZe):
    params = {"format": "json", "url": SourceZe}
